...
public class CaptureActivity extends AppCompatActivity implements BSCallBack {
    ...
    private void initUiFunction() {
        ...
        Glide.with(this).load(mCustomDataModel.stProductImage).into(ivOrderProduct);
    }
    ...
    public void onCloseScanActivity() {
        capture.returnResult(new BarcodeResult(new Result(Util.dataNotFound_Key, null, null, null), null));
//        finish();
    }
}