...
object DecodeFormatManager {
    ...
    private var ONE_D_FORMATS: MutableSet<BarcodeFormat>? = null
    ...
    init {
        ...
        FORMATS_FOR_MODE[Intents.Scan.ONE_D_MODE] =
            ONE_D_FORMATS
        FORMATS_FOR_MODE[Intents.Scan.PRODUCT_MODE] =
            PRODUCT_FORMATS
        FORMATS_FOR_MODE[Intents.Scan.QR_CODE_MODE] =
            QR_CODE_FORMATS
        FORMATS_FOR_MODE[Intents.Scan.DATA_MATRIX_MODE] =
            DATA_MATRIX_FORMATS
    ...
    private fun parseDecodeFormats(
        ...
        if (decodeMode != null) {
            return FORMATS_FOR_MODE!![decodeMode]
        }
        return null
    }
}
